processes = [
    {
        "Class": "GoodPhotons",
        "path": (
            "/mnt/hdfs/store/group/phys_egamma/HATS2021/ID_Training/GJet/",
            ".root",
        ),
        "xsecwt": 1,
...
branches = [
    "phoHoverE",  # in NanoAOD as Photon_hoe
...
ele_branches = [
    ...
    "ele_dr03TkSumPt",
    "ele_dr03EcalRecHitSumEt",
    "ele_dr03HcalTowerSumEt",
    "ele_ecalPFClusterIso",
    "ele_hcalPFClusterIso",
    "ele_gsfchi2",
