...
def update_efficiency(feature1_cut, feature2_cut, feature3_cut, feature4_cut, feature5_cut):
...
percentile=0.95
ele_hadronicOverEm_slider = widgets.FloatSlider(value=0, min=df['ele_hadronicOverEm'].min(), max=df['ele_hadronicOverEm'].quantile(percentile), step=0.1, description='ele_hadronicOverEm:')
ele_fbrem_slider = widgets.FloatSlider(value=0, min=df['ele_ep'].min(), max=df['ele_ep'].quantile(percentile), step=0.2, description='ele_ele_ep:')
...
ele_ecalPFClusterIso_slider = widgets.FloatSlider(
    value=0, min=df['ele_ecalPFClusterIso'].min(), max=df['ele_ecalPFClusterIso'].quantile(percentile),
    step=0.1, description='ele_ecalPFClusterIso:'
)
ele_hcalPFClusterIso_slider = widgets.FloatSlider(
    value=0, min=df['ele_hcalPFClusterIso'].min(), max=df['ele_hcalPFClusterIso'].quantile(percentile),
    step=0.1, description='ele_hcalPFClusterIso:'
)
